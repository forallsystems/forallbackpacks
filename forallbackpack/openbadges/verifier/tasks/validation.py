...
class OBClasses(object):
    ...
    RevokedAssertion = 'RevokedAssertion'
    ...
    ALL_CLASSES = (AlignmentObject, Assertion, BadgeClass, Criteria, CryptographicKey, Endorsement, EndorsementClaim,
                   ...
                   VerificationObjectIssuer, RevokedAssertion)
...
# ADD THIS
                {'task_type': FLATTEN_EMBEDDED_RESOURCE, 'prop_name': 'issuer', 'node_class': OBClasses.Endorsement,
                 'task_key': 'ENDO_FLATTEN_ISS'},
            ]
        ...
        elif class_name == OBClasses.RevokedAssertion:
            self.validators = [
                {'prop_name': 'revoked', 'prop_type': ValueTypes.BOOLEAN, 'required': True},
                {'prop_name': 'revocationReason', 'prop_type': ValueTypes.TEXT, 'required': False},
                {'prop_name': 'uid', 'prop_type': ValueTypes.TEXT, 'required': False},
                {'task_type': ASSERTION_VERIFICATION_CHECK, 'triggers_completion': 'ASSERTION_VALIDATED'}
            ]               
        else:
...
# ADDED THESE TWO
                {'prop_name': 'endorsement', 'prop_type': ValueTypes.ID, 'required': False, 'allow_remote_url': True,
                 'fetch': True, 'allow_data_uri': False, 'expected_class': OBClasses.Endorsement,
                 'prerequisites': class_name+'_FLATTEN_ENDO', 'many': True},
                {'task_type': FLATTEN_EMBEDDED_RESOURCE, 'prop_name': 'endorsement', 'node_class': class_name,
                 'task_key': class_name+'_FLATTEN_ENDO'},        
            ]
