...
from .verification import (
    hosted_id_in_verification_scope, verify_recipient_against_trusted_profile, verify_hosted_assertion_not_revoked)
...
FUNCTIONS = {
    ...
    VERIFY_HOSTED_ASSERTION_NOT_REVOKED:       verify_hosted_assertion_not_revoked
}
